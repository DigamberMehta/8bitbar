...
const calculateActualEndTime = (startTime, duration) => {
  ...
  // Add duration hours to get end time
...
export const getKaraokeBookingTemplate = (booking, roomName) => {
  ...
  return {
    subject: "Your Karaoke Session is Confirmed - 8BitBar",
    html: `
      <!DOCTYPE html>
      <html>
      <head>
        ...
        <title>Karaoke Booking Confirmation</title>
        <style>
      ...
      <body>
        <div class="container">
          <div class="header">
            ...
            <div class="header-subtitle">Gaming Lounge & Karaoke</div>
          </div>
          
          <div class="content">
            <div class="greeting">Hello ${booking.customerName},</div>
            <div class="intro-text">
              Your karaoke room is ready! Get ready to sing your heart out and create unforgettable memories.
            </div>
            
            <div class="booking-card">
              <div class="booking-title">Your Karaoke Session Details</div>
              
              <div class="detail-grid">
                <div class="detail-item">
                  <span class="detail-label">🎤 Room</span>
                  <span class="room-name">${roomName || "Karaoke Room"}</span>
                </div>
      ...
      booking.status
            ...
            <div class="intro-text">
              If you need to make any changes to your booking, please contact us as soon as possible. We can't wait to hear you sing!
            </div>

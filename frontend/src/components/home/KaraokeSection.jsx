        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="grid grid-cols-2 gap-4">
            <img
              ...
              onError={(e) => { e.target.onerror = null; e.target.src='https://placehold.co/600x400/1a202c/ed64a6?text=Karaoke+Room'; }}
            />
            <img
              src="https://8bitbar.com.au/wp-content/uploads/2025/05/eab1029c-b6c9-430c-b0e2-0e80fff6aa21.jpeg"
              alt="Karaoke Room Interior"
              className="w-full h-48 object-cover rounded-lg"
              onError={(e) => { e.target.onerror = null; e.target.src='https://placehold.co/600x400/1a202c/ed64a6?text=Karaoke+Interior'; }}
            />
            <img
              ...
              className="w-full h-48 object-cover rounded-lg"
              onError={(e) => { e.target.onerror = null; e.target.src='https://placehold.co/600x400/1a202c/ed64a6?text=Karaoke+Setup'; }}
            />
            <img
              src="https://8bitbar.com.au/wp-content/uploads/2025/05/275bbbcf-cb28-4acf-b4b2-2fede476aeca.jpeg"
              alt="Karaoke Room Atmosphere"
              className="w-full h-48 object-cover rounded-lg"
              onError={(e) => { e.target.onerror = null; e.target.src='https://placehold.co/600x400/1a202c/ed64a6?text=Karaoke+Atmosphere'; }}
            />
          </div>

          <div>
            <h2 className="font-['Orbitron'] text-3xl md:text-4xl font-bold mb-6 text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-pink-400">
              Sing your heart out in our Karaoke room
            </h2>
            <p className="text-gray-300 text-lg mb-8 leading-relaxed">
              Step through the looking glass into our enchanting Alice in
              Wonderland-themed karaoke room! Perfect for parties,
              celebrations, or just a magical night out. Equipped with 4
              high-quality microphones and a massive library of songs—sing
              your heart out in a whimsical wonderland setting.
            </p>

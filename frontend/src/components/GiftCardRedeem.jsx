    ...
    <div className="bg-black/60 backdrop-blur-sm border border-pink-500/30 rounded-lg shadow-2xl p-4 mb-4">
      ...
      <div className="space-y-3 mb-4">
        ...
        <div className="flex gap-2">
          <button
            ...
            disabled={loading || !giftCardCode.trim() || !giftCardPin.trim()}
      ...
      <div className="mt-4 p-3 bg-white/5 border border-white/10 rounded-lg">
        ...
        <div className="text-xs text-gray-400 space-y-0.5">
          <p>
            • Gift cards can be used partially - remaining balance will be saved
          </p>
          ...
          <p>
            • Gift cards are only redeemed after successful payment completion
          </p>
        </div>
      </div>
    </div>

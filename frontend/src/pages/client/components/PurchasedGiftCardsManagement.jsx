...
const PurchasedGiftCardsManagement = () => {
  ...
  const fetchGiftCards = async () => {
    try {
      setLoading(true);
      // Use the admin endpoint since staff are admin users
  ...
  const handleOfflineRedeem = async (e) => {
    ...
    try {
      ...
      console.log("Frontend redeem request:", {
        ...
        reason: redeemReason || "Offline redemption by staff",
      });
    ...
    if (window.confirm(confirmMessage)) {
      try {
        ...
        await api.post(`/admin/purchased-giftcards/${cardId}/mark-redeemed`, {
          forceRedeem,
          reason: forceRedeem
            ? "Force redeemed by staff"
            : "Marked as redeemed by staff",
        });
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 text-lg">
            Manage and redeem gift cards for customers
          </p>
        </div>
